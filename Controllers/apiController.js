...
export async function getApi(apiUrl,params,tokenUrl,clientId,clientSecret,scope) {
 ...
 export async function postApi(apiUrl,data,tokenUrl,clientId,clientSecret,scope) {
    let accessToken = await getToken(tokenUrl,clientId,clientSecret,scope);                 
    try {     
